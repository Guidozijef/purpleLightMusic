...
var Realtime = function (_EventEmitter) {
  ...
  Realtime.prototype._open = function _open() {
    ...
    this._openPromise = new _Promise(function (resolve, reject) {
      ...
      }).on(ERROR, reject).on(EXPIRE, _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2() {
...
var createPartiallySuccess = function createPartiallySuccess(_ref) {
  ...
  return {
    ...
    failures: failedPids.map(function (_ref2) {
      ...
      return _Object$assign(createError(error), { clientIds: pids });
    })
  };
};
...
var transformNotFoundError = function transformNotFoundError(error) {
  return error.code === ErrorCode.CONVERSATION_NOT_FOUND ? createError({ code: ErrorCode.TEMPORARY_CONVERSATION_EXPIRED }) : error;
};
