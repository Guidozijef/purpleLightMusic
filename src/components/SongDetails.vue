  ...
  <div class="songDetails-container">
    ...
    <div class="songInfo">
      <div class="songImg" v-if="this.prevPlaySong">
        <img :src="(this.prevPlaySong.al.picUrl).slice(0,5) == 'https' ? this.prevPlaySong.al.picUrl : this.prevPlaySong.al.picUrl.replace('http','https')" alt srcset />
      </div>
      <div class="songItem">
...
export default {
  ...
  computed: {
    ...
    // },
    bgImg(){
      return  (this.prevPlaySong.al.picUrl).slice(0,5) == 'https' ? this.prevPlaySong.al.picUrl : this.prevPlaySong.al.picUrl.replace('http','https');
    },
    currentTime1() {
