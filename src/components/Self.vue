        ...
        <div class="songListInfoBox">
          ...
          <div class="songListSum">
            <span calss="number" style="margin-right:5px;">
              共{{prevPlayList.trackCount}}首
            </span>
            <span calss="number" style="margin-right:5px;">
              共播放{{prevPlayList.playCount}}次
            </span>
          </div>
        </div>
      </div>
...
export default {
  ...
  computed: {
    ...mapGetters(["importUserInfo", "prevPlayList"])
  },
  methods: {
    ...mapActions(["setImportUserInfo", "setPrevPlayList"]),
    importList() {
      var uid = "1581414085"
